...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  void updateOrderStatus({required int status}) async {
    int? statuss = await adminServices.updateOrderStatus(context,
        orderId: widget.order.id, status: status);
    if (statuss != null) {
      statuss = statuss;
      setState(() {
        currentStep = statuss!;
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    //~Date parsing from milliseconds.
                    Text(
              ...
              child:
                  ...
                  Stepper(
                      ...
                      controlsBuilder: ((context, details) {
                        //details gives us stem details which we are on.
                        if (user.type == 'admin') {
                          return CustomButton(
                              text: 'Done',
                              onTap: () {
                                updateOrderStatus(status: details.currentStep);
                              });
                        } else {
                    ...
                    Step(
                        ...
                        //If order status is completed or greater than current index we showing tick arrow.
                        state: currentStep > 0
                            ? StepState.complete
                            : StepState.indexed),
                    Step(
                    ...
                    Step(
                        ...
                        content: const Text(
                            'Your order is being delievered and signed by you.'),
